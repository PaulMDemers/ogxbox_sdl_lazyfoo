...
#define LAZYFOO_LESSON_SLUG "viewport"
#define LAZYFOO_LESSON_TITLE "The Viewport"
...
static void fill_viewport(DemoState *state, Uint8 r, Uint8 g, Uint8 b)
{
    SDL_SetRenderDrawColor(state->renderer, r, g, b, 255);
